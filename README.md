...
[![Maturity](https://github.com/giellalt/lang-fkv/raw/generated/docs-data/fst-maturity.svg)](https://giellalt.github.io/MaturityClassification.html)
![Lemma count](https://github.com/giellalt/lang-fkv/raw/generated/docs-data/fst-lemmacount.svg)
[![Speller suggestion quality](https://github.com/giellalt/lang-fkv/raw/generated/docs-data/speller-suggestions.svg)](https://giellalt.github.io/lang-fkv/typosreport/)
...
[![Doc build](https://img.shields.io/github/actions/workflow/status/giellalt/lang-fkv/docs.yml?logo=github&label=DocCI)](https://github.com/giellalt/lang-fkv/actions/workflows/docs.yml)
[![Build Status](https://builds.giellalt.org/api/badge/lang-fkv?logo=buildkite&label=CoreCI)](https://builds.giellalt.org/pipelines/lang-fkv/builds/latest)

Download nightly / CI/CD installation packages for testing (contains the core zhfst file(s)):

[![Windows](https://img.shields.io/badge/download%40latest-Windows--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-fkv?platform=windows&channel=nightly)
[![MacOS](https://img.shields.io/badge/download%40latest-macOS--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-fkv?platform=macos&channel=nightly)
[![Mobile](https://img.shields.io/badge/download%40latest-mobile--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-fkv?platform=mobile&channel=nightly)
...
This repository contains finite state source files for the Kven Finnish language,
for building morphological analysers, proofing tools
and dictionaries. The data and implementation are licenced under __LICENSE__
licence, also detailed in the
[LICENSE](https://github.com/giellalt/lang-fkv/blob/main/LICENSE). The
...
In order to compile and use Kven Finnish language morphology and
...
[INSTALL](https://github.com/giellalt/lang-fkv/blob/main/INSTALL)
