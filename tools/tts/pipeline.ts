...
export default function fkvTextTTS(entry: StringEntry): Command {
  ...
  x = speech.normalize(
    "normaliser", x,
    {
      ...
      normalizers: {
        ...
        "Sem/Date":       "transcriptor-date-digit2text.filtered.lookup.hfstol",
        "Sem/Year":       "transcriptor-date-digit2text.filtered.lookup.hfstol",
