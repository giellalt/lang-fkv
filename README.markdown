...
This directory contains source files for the Kven Finnish language
...
-   <https://giellalt.uit.no/lang/fkv/KvenDocumentation.html> (analyser)
...
The Kven Finnish language sources can be acquired using [giella SVN
